...
async def main_commands(message):
    ...
    greeting = 'Привет, тебя встречает команда reCREARTIVE \n\n'\
               ...
               '/notify_settings - настроить уведомления (ты же не хочешь, чтобы мы тебя разбудили? настрой' \
               ' часовой пояс и время отправки уведомлений) или узнать о уже выбранном времени\n'\
               '/notify - включить уведомления \n'\
               '/exist_notify - узнать о существующих уведомлениях (а вдруг ты все уже настроил? )\n'\
